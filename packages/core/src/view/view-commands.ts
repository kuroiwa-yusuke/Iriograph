import { hasBlockingDiagnostics, sortDiagnostics } from "../projection/diagnostics.js";
import type {
  DiagramView,
  IriographDocument,
  IriographDocumentV1,
...
import { reconcileIriographDocumentViews } from "../projection/reconciliation.js";
import {
  isBcp47LanguageTag,
