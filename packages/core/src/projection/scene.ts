...
} from "../catalog/catalog-resolution.js";
...
import { containerContentInsets } from "../layout/container-content.js";
import { measureNodeContent, measureTextContent, resolveIconContentMetrics } from "../layout/content-metrics.js";
import type {
  DiagramScene,
  EdgeCurveRouting,
  GroupFrame,
...
export function remapProjectedRuleOrigins(
  ...
  const remapTraceCandidate = (
    candidate: import("../document/model.js").ProjectionRuleCandidateTrace,
  ): import("../document/model.js").ProjectionRuleCandidateTrace => {
