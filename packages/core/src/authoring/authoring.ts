...
import { containerContentBounds as boundsForContainer } from "../layout/container-content.js";
...
type PreviewInternalOptions = PreviewAuthoringOptions & {
  semanticWarningConfirmation?: import("../semantic/semantic-validation.js").SemanticWarningConfirmation;
};
